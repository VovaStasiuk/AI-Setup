# Claude Guide For AI Setup

Follow `AGENTS.md`. This repository is an installer/template project, not an app.

When helping a user install or customize it:

- Run dry-runs before real installs.
