...
- Added code-comment discipline to `implementation-agent`: retain only concise, stable rationale near code and move investigation or change history to the implementation summary or durable project records.
